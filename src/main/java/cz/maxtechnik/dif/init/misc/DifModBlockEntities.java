...
import cz.maxtechnik.dif.init.chests.CopperChestTileEntity;
...
public class DifModBlockEntities{
	...
	public static final RegistryObject<BlockEntityType<?>> COPPER_CHEST = REGISTRY.register("copper_chest", () -> BlockEntityType.Builder.of(CopperChestTileEntity::new, DifModBlocks.COPPER_CHEST.get()).build(null));
