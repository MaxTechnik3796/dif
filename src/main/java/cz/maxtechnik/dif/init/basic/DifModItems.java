...
import cz.maxtechnik.dif.item.god.GodTotemItem;
...
import cz.maxtechnik.dif.item.god.*;
...
public class DifModItems{
	...
	public static final RegistryObject<Item> GOD_TOTEM = REGISTRY.register("god_totem",
			() -> new GodTotemItem(new Item.Properties()));
	public static final RegistryObject<Item> GOD_SWORD = REGISTRY.register("god_sword",
			() -> new GodSwordItem(new Item.Properties().fireResistant()));
	...
	public static final RegistryObject<Item> NETHERITE_BATTLE_AXE=REGISTRY.register("netherite_battle_axe",()->new BattleAxeItem(Tiers.NETHERITE,7,-3.3F,new Item.Properties().fireResistant()));
	...
	public static final RegistryObject<Item> NETHERITE_KATANA=REGISTRY.register("netherite_katana",()->new SwordItem(Tiers.NETHERITE,1,-1F,new Item.Properties().fireResistant()));
