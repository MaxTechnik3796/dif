...
public class DifModBlockEntities{
	...
	public static final RegistryObject<BlockEntityType<MonitorBlockEntity>>MONITOR=REGISTRY.register("monitor",()->BlockEntityType.Builder.of(MonitorBlockEntity::new,DifModBlocks.CAMERA_MONITOR.get()).build(null));
