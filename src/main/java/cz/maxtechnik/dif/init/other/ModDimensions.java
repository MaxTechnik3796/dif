...
public class ModDimensions {
    // Pro 1.20.1 je 'new ResourceLocation' naprosto v pořádku. 
    // IDE jen varuje, že v budoucích verzích (1.21+) se to změní.
    ...
    public static void register() {
        DifMod.LOGGER.info("Dimenze pro mod '" + DifMod.MODID + "' byly uspesne zaregistrovany.");
    }
}