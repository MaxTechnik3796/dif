...
public class DifModMobEffects{
	...
	public static final DeferredHolder<MobEffect, MobEffect> REDSTONE_IQ = REGISTRY.register("redstone_iq", RedstoneIQMobEffect::new);
	public static final DeferredHolder<MobEffect, MobEffect> REDSTONE_NOT_IQ = REGISTRY.register("redstone_not_iq", RedstoneNotIQMobEffect::new);
