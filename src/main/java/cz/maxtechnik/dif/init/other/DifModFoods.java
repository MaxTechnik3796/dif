...
public class DifModFoods{
	...
	public static final FoodProperties BEER_BOTTLE=new FoodProperties.Builder().nutrition(4).saturationModifier(1F).effect(new MobEffectInstance(DifModMobEffects.DRANK,600,0),0.25F).effect(new MobEffectInstance(MobEffects.REGENERATION,100,0),0.75F).alwaysEdible().build();
	...
	public static final FoodProperties EXPERIENCE_DRINK=new FoodProperties.Builder().nutrition(4).saturationModifier(3F).effect(new MobEffectInstance(DifModMobEffects.EXPERIENCE,600,0),1F).alwaysEdible().build();
}