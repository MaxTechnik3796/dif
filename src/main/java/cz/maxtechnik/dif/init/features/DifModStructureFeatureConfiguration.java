...
public record DifModStructureFeatureConfiguration(ResourceLocation structure,boolean randomRotation,boolean randomMirror,HolderSet<Block> ignoredBlocks,Vec3i offset) implements FeatureConfiguration {
	public static final Codec<DifModStructureFeatureConfiguration> CODEC = RecordCodecBuilder.create(builder -> {
		...
		})).apply(builder, DifModStructureFeatureConfiguration::new);
	});
}
