...
public class DifModSounds{
    ...
    public static final RegistryObject<SoundEvent>CREMEKA=REGISTRY.register("cremeka",()->SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"cremeka")));
    ...
    public static final RegistryObject<SoundEvent>MAYONNAISE=REGISTRY.register("mayonnaise",()->SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"mayonnaise")));
