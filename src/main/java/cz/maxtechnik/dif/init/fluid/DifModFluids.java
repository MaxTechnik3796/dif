...
public class DifModFluids{
	...
	//JETPACK TURBO FUEL
	public static final DeferredHolder<Fluid,FlowingFluid> JETPACK_TURBO_FUEL=REGISTRY.register("jetpack_turbo_fuel_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.JETPACK_TURBO_FUEL_TYPE,fluidSupplier("jetpack_turbo_fuel_fluid"),fluidSupplier("flowing_jetpack_turbo_fuel_fluid"),DifModItems.JETPACK_TURBO_FUEL_BUCKET,()->(LiquidBlock)DifModBlocks.JETPACK_TURBO_FUEL_FLUID.get(),JetpackTurboFuel.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_JETPACK_TURBO_FUEL=REGISTRY.register("flowing_jetpack_turbo_fuel_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.JETPACK_TURBO_FUEL_TYPE,fluidSupplier("jetpack_turbo_fuel_fluid"),fluidSupplier("flowing_jetpack_turbo_fuel_fluid"),DifModItems.JETPACK_TURBO_FUEL_BUCKET,()->(LiquidBlock)DifModBlocks.JETPACK_TURBO_FUEL_FLUID.get(),JetpackTurboFuel.TICK_RATE)));
	//CIDER
