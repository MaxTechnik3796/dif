...
public class DifModFluids{
	...
	//MOLTEN_IRON
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_IRON=REGISTRY.register("molten_iron_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_IRON_TYPE,fluidSupplier("molten_iron_fluid"),fluidSupplier("flowing_molten_iron_fluid"),DifModItems.MOLTEN_IRON_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_IRON_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_IRON=REGISTRY.register("flowing_molten_iron_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_IRON_TYPE,fluidSupplier("molten_iron_fluid"),fluidSupplier("flowing_molten_iron_fluid"),DifModItems.MOLTEN_IRON_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_IRON_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_COPPER
	...
	//MOLTEN_GOLD
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_GOLD=REGISTRY.register("molten_gold_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_GOLD_TYPE,fluidSupplier("molten_gold_fluid"),fluidSupplier("flowing_molten_gold_fluid"),DifModItems.MOLTEN_GOLD_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_GOLD_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_GOLD=REGISTRY.register("flowing_molten_gold_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_GOLD_TYPE,fluidSupplier("molten_gold_fluid"),fluidSupplier("flowing_molten_gold_fluid"),DifModItems.MOLTEN_GOLD_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_GOLD_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_STEEL
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_STEEL=REGISTRY.register("molten_steel_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_STEEL_TYPE,fluidSupplier("molten_steel_fluid"),fluidSupplier("flowing_molten_steel_fluid"),DifModItems.MOLTEN_STEEL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_STEEL_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_STEEL=REGISTRY.register("flowing_molten_steel_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_STEEL_TYPE,fluidSupplier("molten_steel_fluid"),fluidSupplier("flowing_molten_steel_fluid"),DifModItems.MOLTEN_STEEL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_STEEL_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_OBSIDIAN
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_OBSIDIAN=REGISTRY.register("molten_obsidian_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_OBSIDIAN_TYPE,fluidSupplier("molten_obsidian_fluid"),fluidSupplier("flowing_molten_obsidian_fluid"),DifModItems.MOLTEN_OBSIDIAN_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_OBSIDIAN_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_OBSIDIAN=REGISTRY.register("flowing_molten_obsidian_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_OBSIDIAN_TYPE,fluidSupplier("molten_obsidian_fluid"),fluidSupplier("flowing_molten_obsidian_fluid"),DifModItems.MOLTEN_OBSIDIAN_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_OBSIDIAN_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_ZINC
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_ZINC=REGISTRY.register("molten_zinc_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_ZINC_TYPE,fluidSupplier("molten_zinc_fluid"),fluidSupplier("flowing_molten_zinc_fluid"),DifModItems.MOLTEN_ZINC_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_ZINC_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_ZINC=REGISTRY.register("flowing_molten_zinc_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_ZINC_TYPE,fluidSupplier("molten_zinc_fluid"),fluidSupplier("flowing_molten_zinc_fluid"),DifModItems.MOLTEN_ZINC_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_ZINC_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_BRASS
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_BRASS=REGISTRY.register("molten_brass_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_BRASS_TYPE,fluidSupplier("molten_brass_fluid"),fluidSupplier("flowing_molten_brass_fluid"),DifModItems.MOLTEN_BRASS_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_BRASS_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_BRASS=REGISTRY.register("flowing_molten_brass_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_BRASS_TYPE,fluidSupplier("molten_brass_fluid"),fluidSupplier("flowing_molten_brass_fluid"),DifModItems.MOLTEN_BRASS_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_BRASS_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_NICKEL
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_NICKEL=REGISTRY.register("molten_nickel_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_NICKEL_TYPE,fluidSupplier("molten_nickel_fluid"),fluidSupplier("flowing_molten_nickel_fluid"),DifModItems.MOLTEN_NICKEL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_NICKEL_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_NICKEL=REGISTRY.register("flowing_molten_nickel_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_NICKEL_TYPE,fluidSupplier("molten_nickel_fluid"),fluidSupplier("flowing_molten_nickel_fluid"),DifModItems.MOLTEN_NICKEL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_NICKEL_FLUID.get(),Molten.TICK_RATE)));
	//MOLTEN_MITHRIL
	public static final DeferredHolder<Fluid,FlowingFluid> MOLTEN_MITHRIL=REGISTRY.register("molten_mithril_fluid",()->new BaseFluidBlocks.Source(createProperties(DifModFluidTypes.MOLTEN_MITHRIL_TYPE,fluidSupplier("molten_mithril_fluid"),fluidSupplier("flowing_molten_mithril_fluid"),DifModItems.MOLTEN_MITHRIL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_MITHRIL_FLUID.get(),Molten.TICK_RATE)));
	public static final DeferredHolder<Fluid,FlowingFluid> FLOWING_MOLTEN_MITHRIL=REGISTRY.register("flowing_molten_mithril_fluid",()->new BaseFluidBlocks.Flowing(createProperties(DifModFluidTypes.MOLTEN_MITHRIL_TYPE,fluidSupplier("molten_mithril_fluid"),fluidSupplier("flowing_molten_mithril_fluid"),DifModItems.MOLTEN_MITHRIL_BUCKET,()->(LiquidBlock)DifModBlocks.MOLTEN_MITHRIL_FLUID.get(),Molten.TICK_RATE)));
