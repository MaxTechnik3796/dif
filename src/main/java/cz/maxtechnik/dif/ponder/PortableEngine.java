...
public class PortableEngine{
	public static void intro(SceneBuilder sceneBuilder,SceneBuildingUtil util){
		...
		scene.idle(8);
		narrate(scene,"Portable Engine is a single-block variant of a Modular Engine.",util.vector().centerOf(3,1,3),20);
		scene.idle(4);
		...
		scene.idle(8);
		narrate(scene,"Engine can by stopped by redstone.",util.vector().centerOf(1,1,3),8);
		scene.idle(4);
