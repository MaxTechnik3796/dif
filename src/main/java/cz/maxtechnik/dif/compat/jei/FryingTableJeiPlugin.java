...
public class FryingTableJeiPlugin implements IModPlugin{
	...
	@Override
	public @NotNull ResourceLocation getPluginUid(){ return PLUGIN_ID; }
	...
	public static class FryingCategory implements IRecipeCategory<FryingRecipe>{
		...
		@Override public @NotNull RecipeType<FryingRecipe> getRecipeType(){ return FRYING_TYPE; }
		@Override public @NotNull Component getTitle(){ return Component.translatable("jei.dif.frying_table"); }
