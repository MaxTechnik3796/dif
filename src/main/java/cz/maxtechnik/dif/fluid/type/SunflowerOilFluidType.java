...
public class SunflowerOilFluidType extends FluidType{
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer){
		consumer.accept(new IClientFluidTypeExtensions(){
			private static final ResourceLocation STILL_TEXTURE=ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"block/sunflower_oil_fluid_still"), FLOWING_TEXTURE=ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"block/sunflower_oil_fluid_flow");
			@Override
