...
public class BeerFluidType extends FluidType{
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer){
		consumer.accept(new IClientFluidTypeExtensions(){
			private static final ResourceLocation STILL_TEXTURE=ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"fluid/beer_fluid_still"),FLOWING_TEXTURE=ResourceLocation.fromNamespaceAndPath(DifMod.MODID,"fluid/beer_fluid_flow");
			@Override
