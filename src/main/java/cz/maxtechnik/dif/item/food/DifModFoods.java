...
public class DifModFoods{
	...
	public static final FoodProperties MATY_DRINK=new FoodProperties.Builder().nutrition(13).saturationModifier(2f).effect(new MobEffectInstance(DifModMobEffects.REDSTONE_IQ.get(),1200,0),1F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED,200,0),1F).effect(new MobEffectInstance(MobEffects.DIG_SPEED,100,2),1F).alwaysEat().build();
	...
	public static final FoodProperties BEER=new FoodProperties.Builder().nutrition(4).saturationModifier(1F).effect(new MobEffectInstance(DifModMobEffects.DRANK.get(),600,0),0.25F).effect(new MobEffectInstance(MobEffects.REGENERATION,100,0),0.75F).alwaysEat().build();
	...
	public static final FoodProperties WINE=new FoodProperties.Builder().nutrition(5).saturationModifier(1.3F).effect(new MobEffectInstance(MobEffects.REGENERATION,100,0),0.75F).effect(new MobEffectInstance(DifModMobEffects.DRANK.get(),600,0),0.25F).alwaysEat().build();
	...
	public static final FoodProperties BOTTLE_OF_URANOVEJ_KOKTEJL=new FoodProperties.Builder().nutrition(4).saturationModifier(3F).effect(new MobEffectInstance(DifModMobEffects.WTF.get(),1200,0),1F).alwaysEat().build();
