...
public class DifModFoods{
	...
	public static final FoodProperties BEER=new FoodProperties.Builder().nutrition(4).saturationMod(1F).effect(new MobEffectInstance(DifModMobEffects.DRANK.get(),600,0),0.25F).effect(new MobEffectInstance(MobEffects.REGENERATION,100,0),0.75F).alwaysEat().build();
