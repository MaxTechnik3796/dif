...
public enum ModularReforge{
	...
	SWIFT("swift",new ModularTools[]{SWORD,AXE,KATANA},false,
			0.95F, 1.15F, 1F, 1F),
	HEAVY("heavy",new ModularTools[]{SWORD,BATTLE_AXE,KATANA},false,
			1.25F, 0.9F, 1F, 1F),
	...
	REINFORCED("reinforced",new ModularTools[]{AXE,PICKAXE,SHOVEL,HOE,BATTLE_AXE,HAMMER,EXCAVATOR,TIMBER_AXE},false,
			1F, 1F, 1F, 1.1F),
	...
	STURDY("sturdy",new ModularTools[]{AXE,PICKAXE,SHOVEL,HOE,HAMMER,EXCAVATOR,TIMBER_AXE},true,
			1F, 1F, 0.9F, 1.2F),
	ARCANE("arcane",new ModularTools[]{PICKAXE,HAMMER,SHOVEL,EXCAVATOR},false,
			1F, 1F, 1.2F, 0.9F),
