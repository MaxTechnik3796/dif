...
public record ModularToolProperties(String toolType,String headMaterial,String bindingMaterial,String handleMaterial,String reforge){
	...
	public static final ModularToolProperties DEFAULT=new ModularToolProperties(ModularTools.NONE.getName(),ModularMaterial.WOOD.getName(),ModularMaterial.WOOD.getName(),ModularMaterial.WOOD.getName(),ModularReforge.NONE.getName());
}