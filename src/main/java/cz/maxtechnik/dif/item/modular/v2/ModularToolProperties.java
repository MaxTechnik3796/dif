...
public record ModularToolProperties(String toolType,String headMaterial,String bindingMaterial,String handleMaterial,String tier,float critMultiplier){
	public static final Codec<ModularToolProperties> CODEC=RecordCodecBuilder.create(instance->instance.group(
			...
			Codec.FLOAT.optionalFieldOf("crit_multiplier",1.0F).forGetter(ModularToolProperties::critMultiplier)
	).apply(instance,ModularToolProperties::new));
	public static final ModularToolProperties DEFAULT=new ModularToolProperties("none","wood","wood","wood","common",1.0F);
}