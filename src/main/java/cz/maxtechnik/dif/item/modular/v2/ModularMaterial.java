...
public enum ModularMaterial{
	...
	GOLD("gold","c:molten_gold",32,12F,1,0F,8,16,RARE,LUCKY_MAT,0xFFD700,1),
	STEEL("steel","c:molten_steel",1280,8F,3,3F,320,640,EPIC,MOMENTUM,0x434343,1),
	OBSIDIAN("obsidian","c:molten_obsidian",1536,4F,3,2F,384,768,RARE,UNBREAKABLE_MAT,0x2A1F3D,0),
	ZINC("zinc","c:molten_zinc",240,6F,2,2F,60,120,RARE,SELF_REPAIR,0xB5D1BA,1),
	BRASS("brass","c:molten_brass",512,7F,3,2F,128,256,RARE,PRECISE,0xE4B763,1),
	NICKEL("nickel","c:molten_nickel",140,6F,2,2F,35,70,RARE,TOXIC,0xBFC6CB,1),
	MITHRIL("mithril","c:molten_mithril",1040,9F,4,2F,260,640,EPIC,LIGHTWEIGHT,0x80CDB4,1);
