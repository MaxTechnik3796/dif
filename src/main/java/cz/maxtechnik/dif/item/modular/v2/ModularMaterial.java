...
public enum ModularMaterial{
	...
	STEEL("steel",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0x434343),
	OBSIDIAN("obsidian",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0x2A1F3D),
	ZINC("zinc",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0xB5D1BA),
	BRASS("brass",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0xE4B763),
	NICKEL("nickel",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0xBFC6CB),
	MITHRIL("mithril",1,12F,3,2F,1,1,0.1F,EPIC,MAGNETIC,0x80CDB4);
