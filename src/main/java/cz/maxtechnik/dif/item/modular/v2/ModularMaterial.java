...
public enum ModularMaterial{
	...
	WOOD("wood","",40,2F,0,0F,10,20,0.2F,COMMON,RENEWABLE,0x745631,0),
	STONE("stone","",96,4F,1,1F,24,48,0.0F,COMMON,STONEBOUND,0x838383,0),
	IRON("iron","c:molten_iron",168,6F,2,2F,42,84,0.1F,RARE,MAGNETIC,0xDCDCDC,1),
	COPPER("copper","c:molten_copper",96,5F,1,1.5F,32,64,0.1F,RARE,VERDANT,0xD4845A,1),
	GOLD("gold","c:molten_gold",32,12F,0,0F,8,16,0.6F,RARE,LUCKY_MAT,0xFFD700,1),
	STEEL("steel","c:molten_steel",1280,8F,3,2F,320,640,0.1F,EPIC,MOMENTUM,0x434343,1),
	OBSIDIAN("obsidian","c:molten_obsidian",1536,4F,3,2F,384,768,0.1F,RARE,UNBREAKABLE_MAT,0x2A1F3D,0),
	ZINC("zinc","c:molten_zinc",240,6F,3,2F,60,120,0.1F,RARE,SELF_REPAIR,0xB5D1BA,1),
	BRASS("brass","c:molten_brass",512,7F,3,2F,128,256,0.1F,RARE,PRECISE,0xE4B763,1),
	NICKEL("nickel","c:molten_nickel",140,6F,3,2F,35,70,0.1F,RARE,TOXIC,0xBFC6CB,1),
	MITHRIL("mithril","c:molten_mithril",1040,9F,3,2F,260,640,0.1F,EPIC,LIGHTWEIGHT,0x80CDB4,1);
