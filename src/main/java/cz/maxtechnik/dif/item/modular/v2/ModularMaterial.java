...
public enum ModularMaterial{
	WOOD("wood","",60,2F,0,0F,10,1,0.2F,COMMON,RENEWABLE,0x745631),STONE("stone","",130,4F,1,1F,20,1,0.0F,COMMON,STONEBOUND,0x838383),IRON("iron","c:molten_iron",250,6F,2,2F,50,1,0.1F,RARE,MAGNETIC,0xDCDCDC),COPPER("copper","c:molten_copper",180,5.5F,1,1.5F,30,1,0.1F,RARE,VERDANT,0xD4845A),GOLD("gold","c:molten_gold",32,12F,0,0F,5,1,0.6F,RARE,LUCKY_MAT,0xFFD700),STEEL("steel","c:molten_steel",1,12F,3,2F,1,1,0.1F,EPIC,MOMENTUM,0x434343),OBSIDIAN("obsidian","c:molten_obsidian",1,12F,3,2F,1,1,0.1F,EPIC,UNBREAKABLE_MAT,0x2A1F3D),ZINC("zinc","c:molten_zinc",1,12F,3,2F,1,1,0.1F,EPIC,SELF_REPAIR,0xB5D1BA),BRASS("brass","c:molten_brass",1,12F,3,2F,1,1,0.1F,EPIC,PRECISE,0xE4B763),NICKEL("nickel","c:molten_nickel",1,12F,3,2F,1,1,0.1F,EPIC,TOXIC,0xBFC6CB),MITHRIL("mithril","c:molten_mithril",1,12F,3,2F,1,1,0.1F,EPIC,LIGHTWEIGHT,0x80CDB4);
