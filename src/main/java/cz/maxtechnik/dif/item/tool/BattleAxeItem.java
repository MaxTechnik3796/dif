...
import net.minecraft.world.entity.LivingEntity; // Nutné pro canDisableShield

// Pro mapování odkorňování
...
public class BattleAxeItem extends SwordItem {
    ...
    public @NotNull InteractionResult useOn(UseOnContext context) {
        ...
        Optional<BlockState> optional = Optional.ofNullable(AXE_STRIPPABLES.get(blockstate.getBlock()))
