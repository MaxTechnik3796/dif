...
public class NuclearExplosionEntity extends Entity{
	...
	private static final double HOR_R_FULL=42, HOR_R_TOTAL=96, UP_R_FULL=48, UP_R_TOTAL=56, DOWN_R_FULL=12, DOWN_R_TOTAL=18, HOR_FULL_SQ=HOR_R_FULL*HOR_R_FULL, HOR_TOTAL_SQ=HOR_R_TOTAL*HOR_R_TOTAL, UP_FULL_SQ=UP_R_FULL*UP_R_FULL, UP_TOTAL_SQ=UP_R_TOTAL*UP_R_TOTAL, DN_FULL_SQ=DOWN_R_FULL*DOWN_R_FULL, DN_TOTAL_SQ=DOWN_R_TOTAL*DOWN_R_TOTAL;
