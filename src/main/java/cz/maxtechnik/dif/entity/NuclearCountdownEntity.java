...
public class NuclearCountdownEntity extends Entity {
    ...
    public void setCountdown(int ticks) { this.entityData.set(DATA_COUNTDOWN, ticks); }
    public int getCountdown()           { return this.entityData.get(DATA_COUNTDOWN); }
    ...
    @Override
    protected void readAdditionalSaveData(CompoundTag tag) { setCountdown(tag.getInt("Countdown")); }
    @Override
    protected void addAdditionalSaveData(CompoundTag tag)  { tag.putInt("Countdown", getCountdown()); }
