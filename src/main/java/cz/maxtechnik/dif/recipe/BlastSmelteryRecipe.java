...
public record BlastSmelteryRecipe(
    ...
    public boolean hasFluidInput()  { return !fluidInput.isEmpty(); }
    public boolean hasItemInput()   { return !itemIngredient.isEmpty(); }
    public boolean hasFluidOutput() { return !fluidOutput.isEmpty(); }
    public boolean hasItemOutput()  { return !itemResult.isEmpty(); }
    ...
    public static class Serializer implements RecipeSerializer<BlastSmelteryRecipe> {
        @Override public @NotNull MapCodec<BlastSmelteryRecipe> codec() { return CODEC; }
        @Override public @NotNull StreamCodec<RegistryFriendlyByteBuf, BlastSmelteryRecipe> streamCodec() { return STREAM_CODEC; }
    }
}
