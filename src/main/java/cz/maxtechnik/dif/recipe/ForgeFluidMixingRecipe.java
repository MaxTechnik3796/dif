...
public record ForgeFluidMixingRecipe(
	...
	public net.minecraft.world.level.material.Fluid fluidA(){
		return inputFluidA.getFluid();
	}
	/** Fluid B který recept konzumuje. */
	public net.minecraft.world.level.material.Fluid fluidB(){
		return inputFluidB.getFluid();
	}
	/** Kolik mB A se odebere za 1 dávku. */
	public int consumeA(){
		return inputFluidA.getAmount();
	}
	/** Kolik mB B se odebere za 1 dávku. */
	public int consumeB(){
		return inputFluidB.getAmount();
	}
	/**
	...
	public @NotNull RecipeSerializer<?> getSerializer(){
		return DifModRecipes.FORGE_FLUID_MIXING_SERIALIZER.get();
	}
	@Override
	public @NotNull RecipeType<?> getType(){
		return DifModRecipes.FORGE_FLUID_MIXING_TYPE.get();
	}
	// ── Serializer ────────────────────────────────────────────────────────────
	public static class Serializer implements RecipeSerializer<ForgeFluidMixingRecipe>{
		@Override
		public @NotNull MapCodec<ForgeFluidMixingRecipe> codec(){
			return CODEC;
		}
		@Override
		public @NotNull StreamCodec<RegistryFriendlyByteBuf,ForgeFluidMixingRecipe> streamCodec(){
			return STREAM_CODEC;
		}
	}
}