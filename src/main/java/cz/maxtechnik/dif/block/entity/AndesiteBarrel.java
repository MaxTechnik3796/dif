...
public class AndesiteBarrel extends RandomizableContainerBlockEntity implements WorldlyContainer {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(@NotNull Level level, @NotNull BlockPos pos, @NotNull BlockState state) {
            ...
            level.setBlock(pos, state.setValue(cz.maxtechnik.dif.block.AndesiteBarrel.OPEN, true), 3);
        }
        @Override
        protected void onClose(@NotNull Level level, @NotNull BlockPos pos, @NotNull BlockState state) {
            level.playSound(null, pos, SoundEvents.BARREL_CLOSE, SoundSource.BLOCKS, 1.0F, 1.0F);
            level.setBlock(pos, state.setValue(cz.maxtechnik.dif.block.AndesiteBarrel.OPEN, false), 3);
        }
        @Override
