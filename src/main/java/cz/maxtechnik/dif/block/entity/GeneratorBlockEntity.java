...
public class GeneratorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer{
	...
	private int currentFuelItemBurnTime;
	...
	public final ContainerData dataAccess = new SimpleContainerData(3) {
		...
		public int get(int index) {
			return switch (index) {
				...
				case 1 -> GeneratorBlockEntity.this.energyStorage.getEnergyStored();
				case 2 -> GeneratorBlockEntity.this.currentFuelItemBurnTime;
		...
		public void set(int index, int value) {
			switch (index) {
				...
				case 1 -> { /* Energy storage is read-only for client via dataAccess */ }
				case 2 -> GeneratorBlockEntity.this.currentFuelItemBurnTime = value;
			}
		}
	...
	public void saveAdditional(@NotNull CompoundTag compound) {
		...
		compound.putInt("currentFuelItemBurnTime", this.currentFuelItemBurnTime);
