...
public class SturdyBarrelScreen extends AbstractContainerScreen<SturdyBarrelMenu>{
	...
	public SturdyBarrelScreen(SturdyBarrelMenu container,Inventory inventory,Component text){
