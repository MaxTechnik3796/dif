...
public class BurningGeneratorMenu extends AbstractContainerMenu implements Supplier<Map<Integer,Slot>>{
	...
	public BurningGeneratorMenu(int id,Inventory inv,FriendlyByteBuf extraData){
		...
		if(pos!=null) blockEntityFromWorld=this.world.getBlockEntity(pos);
		if(blockEntityFromWorld instanceof BurningGeneratorBlockEntity gen){
			IItemHandler cap=world.getCapability(Capabilities.ItemHandler.BLOCK,pos,null);
			this.internal=cap!=null?cap:new ItemStackHandler(1);
	...
	public int getLit(){ return this.data.get(2); }
	public int getEnergyStored(){ return this.data.get(3); }
	public int getMaxEnergyStored(){ return this.data.get(4); }
	public int getFuel(){ return this.data.get(5); }
	public int getEmpty(){ return this.data.get(6); }
